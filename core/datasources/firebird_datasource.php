...
class FirebirdDatasource extends Datasource {
    ...
    public function connect() {
        $this->connection = ibase_connect($this->config["host"], $this->config["user"], $this->config["password"]);
    ...
    public function query($sql = null) {
        $this->results = ibase_query($this->getConnection(),$sql);
        return $this->results;
    }
    /**
    ...
    public function fetchRow($results = null) {
        ...
        return ibase_fetch_assoc($results);
    }
    /**
    ...
    public function listSources() {
        if(empty($this->sources)):
            ...
            while($source = ibase_fetch_array($sources)):
