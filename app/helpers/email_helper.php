...
class EmailHelper extends Helper {
   ...
   * @var string
   */
  public $From              = 'avisos@assistecinformatica.com.br';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'Assistec Informática - Avisos';
   ...
   * @var string
   */
  public $Host          = 'mail.assistecinformatica.com.br';
   ...
   * @var string
   */
  public $Username      = 'avisos@assistecinformatica.com.br';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'd353ny0lv1m70';
