...
$conta_cedente = formata_numero($dadosboleto["conta_cedente"],5,0);
//dv da conta cedente
...
$codConvenio = $dadosboleto["codConvenio"];

// 43 numeros para o calculo do digito verificador do codigo de barras
$dv = digitoVerificador_barra("$codigobanco$nummoeda$fator_vencimento$valor$conta_cedente$agencia$codConvenio$nnum", 9, 0);
 
// Numero para o codigo de barras com 44 digitos
$linha = "$codigobanco$nummoeda$dv$fator_vencimento$valor$conta_cedente$agencia$codConvenio$nnum";

$agencia_codigo = $agencia.".".$codConvenio.".". $conta_cedente ."-". $conta_cedente_dv;
