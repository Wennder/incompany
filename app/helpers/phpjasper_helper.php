...
class phpjasperHelper extends Helper {

    private $adjust = 1.2;
    public $debugsql = false;

    public function phpjasperHelper($obj = null, $lang = "en") {
        $this->lang = $lang;
    }
...
/////////////////////////////////////////////////////display to pdf part/////////////////////////////////////////////////////////////
    ...
    public function columnHeader() {
        if (isset($this->arraycolumnHeader)) {
            $this->arraycolumnHeader[0][y_axis] = $this->arrayPageSetting[topMargin];
        }
        foreach ($this->arraycolumnHeader as $out) {
            switch ($out[hidden_type]) {
                case "field":
                    $this->display($out, $this->arraycolumnHeader[0][y_axis], true);
                    break;
                default:
                    $this->display($out, $this->arraycolumnHeader[0][y_axis], false);
                    break;
            }
        }
